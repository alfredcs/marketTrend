...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument("--region", default="us-west_2", type=string, help="Kinesis region")
        parser.add_argument("--stream", help="Steam name")
        parser.add_argument("--file", help="Path to a file")
        parser.add_argument("--interval", default=10, type=int, help="Path to a file")
        ...
        if len(sys.argv) == 4:
            ...
            interval = 1000
        main(stream, line_separated_tweets_json_filename, arg.interval)
